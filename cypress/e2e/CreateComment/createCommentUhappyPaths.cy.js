describe("Comment Page Unhappy Path", () => {
    it("check if error msg will be displayed if comment that is more than 200 characters is being input", () => {
        ...
        cy.get('[data-cy="comment-textarea"]').type(
            "Comment must be less than 200 characters!Comment must be less than 200 characters!Comment must be less than 200 characters!Comment must be less than 200 characters!Comment must be less than 200 charact"
        );
    ...
    it("check if error msg will be displayed if user tries to submit comment wil less than 10 characters", () => {
        //first we login the user
        cy.visit("http://localhost:3000/login");
        ...
        //then we create a new comment with less than 10 characters and check if alert msg will be displayed and if the url will not change

        cy.get('[data-cy="comment-textarea"]').type("Short com");
        cy.get('[data-cy="comment-submit-btn"]').then(($button) => {
        ...
        cy.on("window:alert", (message) => {
            expect(message).to.equal(
                "Comment must be at least 10 character long!"
            );
        });
    });

    it("check if error msg will be displayed if user tries to submit empty comment", () => {
        //first we login the user
        cy.visit("http://localhost:3000/login");
        ...
        //then we try to sumbmit empty comment and check if alert msg will be displayed and if the url will not change
